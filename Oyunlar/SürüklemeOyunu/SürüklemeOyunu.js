...
if (reversed == null) { reversed = false; }
	...
	this.shape_2.graphics.f("#CC33CC").s().p("AABnfIHfO/Iu/AAg");
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF6600").s().p("AABE0Ik3CsIBCleIkEjyIFigtICXlCICWFCIFiAtIkEDyIBDFeg");
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFF33").s().p("AnfHgIAAu/IO/AAIAAO/g");
...
(lib.Triangle_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.shape_4.graphics.f("#FFFFFF").s().p("AhqiAIDVCAIjVCBg");
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("Ah1B2IAAjrIDrAAIAADrg");
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#66CC33").s().p("AizHgQh8AAhYhYQhYhYAAh8IAAlnQAAh8BYhYQBYhYB8AAIFnAAQB8AABYBYQBYBYAAB8IAAFnQAAB8hYBYQhYBYh8AAg");
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#3333FF").s().p("AlSFTQiNiNAAjGQAAjGCNiNQCMiMDGAAQDHAACMCMQCNCNAADGQAADGiNCNQiMCNjHAAQjGAAiMiNg");
...
if (reversed == null) { reversed = false; }
	...
	// icon
	this.instance = new lib.Square_1("single",0);
...
if (reversed == null) { reversed = false; }
	...
	// icon
	this.instance = new lib.Triangle_1("single",0);
	this.instance.alpha = 0.8008;
...
// stage content:
(lib.SürüklemeOyunu = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.player0.setTransform(478,475.95,0.66,0.66,0,0,0,0,0.1);
...
p.nominalBounds = new cjs.Rectangle(492.8,287.4,454.49999999999994,210.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"sounds/Song0.mp3?1667655735983", id:"Song0"},
		{src:"sounds/correct.mp3?1667655735983", id:"correct"},
		{src:"sounds/win.mp3?1667655735983", id:"win"},
		{src:"sounds/fail.mp3?1667655735983", id:"fail"}
	],
	preloads: []
};
